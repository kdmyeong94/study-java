...
public class CosmeticMen {
	...
	public String lotion2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 로션 정하기
		
		String[] cos = {"트러블로션1","트러블로션2","트러블로션3","트러블로션4","트러블로션5"}; // 트러블로션 종류
		
		 String b = "";  // 추천될 트러블로션를 담을 변수
		switch (a) { // 트러블 정도에 따라서 트러블로션 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
	...
	public String allInOne2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 트러블올인원 정하기
		
		String[] cos = {"트러블올인원1","트러블올인원2","트러블인원3","트러블올인원4","트러블올인원5"}; // 트러블올인원 종류
		
		String b = "";  // 추천될 트러블올인원를 담을 변수
		switch (a) { // 트러블 정도에 따라서 트러블올인원 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
