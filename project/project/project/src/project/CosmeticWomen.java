...
public class CosmeticWomen {
	...
	public String toner2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 토너 정하기
		
		String[] cos = {"트러블토너","트러블토너2","트러블토너3","트러블토너4","트러블토너5"}; // 트러블토너 종류
		
		 String b = "";  // 추천될 트러블토너를 담을 변수
		switch (a) { // 건조한 정도에 따라서 트러블토너 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
	...
	public String essence2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 에센스 정하기
		
		String[] cos = {"트러블에센스1","트러블에센스2","트러블에센스3"
				,"트러블에센스4","트러블에센스5"}; // 트러블에센스 종류
		
		 String b = "";  // 추천될 트러블 에센스를 담을 변수
		switch (a) { //  정도에 따라서 트러블에센스 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
	...
	public String lotion2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 트러블 로션 정하기
		
		String[] cos = {"트러블로션1","트러블로션2","트러블로션3"
				,"트러블로션4","트러블로션5"}; // 트러블 로션 종류
		
		 String b = "";  // 추천될 트러블 로션를 담을 변수
		switch (a) { // 트러블 정도에 따라서 트러블 로션 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
	...
	public String cream2(int a) {  //트러블 정도를 정수값으로 받아와서 해당 트러블 크림 정하기
		
		String[] cos = {"트러블크림1","트러블크림2","트러블크림3","트러블크림4","트러블크림5"}; // 트러블 크림 종류
		
		 String b = "";  // 추천될 트러블 크림를 담을 변수
		switch (a) { // 트러블 정도에 따라서 트러블 크림 정하기 위한 조건문
		case 1: { b = cos[0]+", " +cos[1]; break;}
		case 2: { b = cos[0]+", " +cos[1]+", " +cos[2]; break;}
		case 3: { b = cos[1]+", " +cos[2]+", " +cos[3]; break;}	
		case 4: { b = cos[2]+", " +cos[3]+", " +cos[4]; break;}
